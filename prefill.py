  ...
  # ══════════════════════════════════════════════════════════════
  {
    ...
    "regulatory_tracker": [
      ...
      },
      {
        ...
        "status": "risk",
        "notes": (
          "California AG Rob Bonta confirmed California will conduct its own independent antitrust review and confirmed "
          "'interest from other states' in the deal. Coalition led by Center for American Progress Action Fund wrote letter "
          "to state AGs calling for legal challenge, arguing merger reduces major film studios from 5 to 4. Former DOJ "
          "antitrust chief Bill Baer: 'a combined lawsuit by state attorneys general presents a real threat.'"
        ),
        "source_url": "https://deadline.com/2026/03/paramount-warner-bros-state-attorneys-general-1236746176/",
        "source_date": "Mar 6, 2026"
      },
      {
    ...
    "timeline_milestones": [
      ...
      {"label": "Shareholder Vote",  "date": "Early Spring 2026",  "status": "upcoming"},
    ...
    "facts": {
      ...
      "latest_news": [
        {
          "fact": (
            "Mar 6, 2026 — Coalition of public interest groups led by Center for American Progress Action Fund wrote letter "
            "to California AG Rob Bonta and other state AGs calling for legal challenge to the merger. Letter argues the "
            "combination reduces major film studios from 5 to 4. California AG Bonta confirmed California will conduct its "
            "own independent antitrust review and acknowledged 'interest from other states' in the deal."
          ),
          "hedged": False,
